...
internal static class OpencodeWrapConstants
{
    ...
    public const string CONTAINER_XDG_ROOT = CONTAINER_OCW_ROOT;
    public const string CONTAINER_XDG_CONFIG_HOME = $"{CONTAINER_OCW_ROOT}/.config";
    public const string CONTAINER_XDG_DATA_HOME = $"{CONTAINER_OCW_ROOT}/.local/share";
    public const string CONTAINER_XDG_STATE_HOME = $"{CONTAINER_OCW_ROOT}/.local/state";
